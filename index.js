const contentLetterSrart_actived = "Bấm vào icon hộp quà đii :v"; //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc bé iu sinh nhật vui vẻ :3"; //Nội dung của bức thư
